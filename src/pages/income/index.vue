...
<template>
  <view v-if="bill" class="page income-page"
    ><view class="income-hero"
      ...
      ><view class="trend"
        ><view class="trend__bars"
          ><i></i><i></i><i></i><i></i><i></i><i></i><i></i></view
        ><text>本周履约表现稳定</text></view
      ></view
    ...
    ><view v-for="r in bill.records" :key="r.id" class="record card"
      ...
      ><view class="record__content"
        ...
        ><text class="muted"
          >{{ r.orderNo }} ·
          {{ r.createdAt.slice(5, 16).replace("T", " ") }}</text
        ></view
...
.trend__bars i:nth-child(1) {
  height: 16rpx;
}
.trend__bars i:nth-child(2) {
  height: 28rpx;
}
.trend__bars i:nth-child(3) {
  height: 22rpx;
}
.trend__bars i:nth-child(4) {
  height: 38rpx;
}
.trend__bars i:nth-child(5) {
  height: 31rpx;
}
.trend__bars i:nth-child(6) {
  height: 45rpx;
}
.trend__bars i:nth-child(7) {
  height: 40rpx;
}
.breakdown {
  display: grid;
